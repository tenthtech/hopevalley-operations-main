...
export const Route = createFileRoute("/contact")({
  head: () =>
    pageSeo({
      title: "Contact",
      description:
        "Contact HopeValley Operations to discuss customer support outsourcing, outbound sales teams, back-office support, or optional hybrid AI + human coverage. Pricing discussed in euros.",
      ogDescription: "Tell us what you need to scale and we will recommend the right pilot or team setup.",
    }),
  component: Page,
});
        ...
        <div className="container-x grid lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="glass-card p-6">
              ...
              <p className="mt-3 text-sm text-soft">Structured coordination, transparent communication, and reliable execution.</p>
              <a
