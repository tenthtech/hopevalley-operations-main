...
export const Route = createFileRoute("/pricing")({
  head: () =>
    pageSeo({
      ...
      description:
        "hopeValley BPO pricing in euros: pilot programs, dedicated agents, customer support outsourcing, sales outreach, back-office support, and optional AI-assisted coverage.",
      ogDescription:
        "Start small, validate quality in a paid pilot, then scale monthly capacity when the setup works.",
    }),
  component: Page,
});
    ...
    <>
      ...
      <section className="section pt-0">
        <div className="container-x">
          <SectionHeader
            label="Pilot Pricing"
            title="Pilot Program — €5 – €6 / hour"
            subtitle="Typical setup: 5 days · 1–3 agents · 4–5 hrs/day per agent · limited campaign scope · basic performance reporting."
          />
          ...
          <p className="mt-6 text-sm text-muted-foreground max-w-3xl">
            The pilot is designed to validate fit, communication, workflow, and execution. It is not
            positioned as a full-scale performance guarantee.
          </p>
        </div>
      </section>
        ...
        <div className="container-x">
          ...
          <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {MONTHLY.map((m) => (
              <div
                key={m.t}
                className={`glass-card p-6 ${m.featured ? "ring-1 ring-primary/40" : ""}`}
              >
            ...
            <div className="mt-8 overflow-x-auto rounded-2xl border border-border">
              <table className="w-full min-w-[280px] text-sm">
                <caption className="sr-only">
                  Standard hourly rates in euros, excluding VAT where applicable
                </caption>
                <thead>
            ...
            <div className="mt-8 glass-card p-6">
              <CheckList
                ...
                items={[
                  ...
                  "CRM or ticketing tool subscriptions",
                  "Custom integrations",
                  "Lead generation",
                  "Advanced script creation",
                  "Dedicated supervisor for larger teams",
                ]}
              />
            </div>
          </div>
        ...
        <div className="container-x grid items-start gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            <SectionHeader
              ...
              subtitle="Share the service type, expected team size, tools, and coverage model so we can prepare a tailored proposal."
            />
          </div>
          <div className="lg:col-span-7">
            <LeadForm submitLabel="Get Monthly Pricing" source="pricing" />
          </div>
        </div>
      </section>
